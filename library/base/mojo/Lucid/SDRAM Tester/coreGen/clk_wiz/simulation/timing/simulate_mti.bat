...
vlog -work work clk_wiz_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax clk_wiz_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.clk_wiz_tb work.glbl
