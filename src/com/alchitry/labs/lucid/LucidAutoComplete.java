...
public class LucidAutoComplete implements AutoComplete {
	...
	public LucidAutoComplete(StyledCodeEditor editor, Dictionary dict) {
		this.editor = editor;
		dictionary = dict;
