...
public class CustomConsole extends StyledText {
    private final DoubleClickHighlighter doubleClick;
    private final List<LineStyleListener> lineStyleListeners;
    private final List<StyleRange> styles;
    private StyleRange[] cachedStyles;
    private boolean newStyles = false;
    private final CustomSearch search;
    ...
    public CustomConsole(Composite parent, int style) {
        ...
        final MenuItem toggleWordwrap = createItem(consoleMenu, "", new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                Settings.INSTANCE.setWORD_WRAP(getWordWrap());
            }
        });

        if (Settings.INSTANCE.getWORD_WRAP()) {
            setWordWrap(true);
