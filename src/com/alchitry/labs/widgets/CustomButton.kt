...
class CustomButton(parent: Composite?, style: Int) : Canvas(parent, style) {
    private var mouse = 0
    ...
    private fun paintControl(e: PaintEvent) {
        ...
        when (mouse) {
            0 -> {
                if (Theme.set) e.gc.background = background
    ...
    init {
        ...
        addMouseTrackListener(object : MouseTrackAdapter() {
            override fun mouseEnter(e: MouseEvent) {
                this@CustomButton.mouseEnter(e)
            }

            override fun mouseExit(e: MouseEvent) {
                this@CustomButton.mouseExit(e)
            }
        })
        addMouseListener(object : MouseAdapter() {
            override fun mouseDown(e: MouseEvent) {
                this@CustomButton.mouseDown(e)
            }

            override fun mouseUp(e: MouseEvent) {
                this@CustomButton.mouseUp(e)
            }
        })
        addKeyListener(object : KeyAdapter() {
            override fun keyPressed(e: KeyEvent) {
                this@CustomButton.keyPressed(e)
            }
        })
    }
}